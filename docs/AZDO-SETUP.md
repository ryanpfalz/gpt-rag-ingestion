# Multi-Environment Azure DevOps Setup - Ingestion
...
If you haven't deployed the [Frontend](https://github.com/Azure/gpt-rag-frontend) or [Orchestrator](https://github.com/Azure/gpt-rag-orchestrator) services, deploy these next.
